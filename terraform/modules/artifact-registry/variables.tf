...
variable "environment" {
  description = "Environnement (dev, staging, prod, prd)"
  type        = string
  validation {
    condition     = contains(["dev", "staging", "prod", "prd"], var.environment)
    error_message = "L'environnement doit être 'dev', 'staging', 'prod' ou 'prd'."
  }
}
